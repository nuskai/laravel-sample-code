...
// metis menu
  ...
  // Sparkline
  mix.copy( srcJs + 'jquery.sparkline.js', destJs);
  // metis menu
  mix.copy( srcJs + 'jquery.slimscroll.min.js', destJs);
...
// login 2 page
    ...
    mix.copy(srcJs + 'pages/plans.js', destJs + 'pages');
    mix.copy(srcJs + 'pages/register.js', destJs + 'pages');
...
//googlemap
    mix.copy( srcJs + 'frontend/google_map_api.js', destJs + 'frontend');
    mix.copy( srcCss + 'frontend/google_map_api.css', destCss + 'frontend');

//dashboard page for google map api
    mix.copy( srcJs + 'frontend/dashboard.js', destJs + 'frontend');
...
//dymanic dashboard
    ...
    mix.copy( srcCss + 'pages/register.css', destCss + 'pages');
    mix.copy( srcCss + 'frontend/dashboard.css', destCss + 'frontend');
...
//jquery.newsTicker
    ...
    mix.sass( resourcesAssets + 'sass/home_styles/style.scss',destCss +'homer.css');

    mix.copy(resourcesAssets + 'styles/', dest + 'styles/');

    mix.copy(resourcesAssets + 'scripts/', dest + 'scripts/');
  ...
  mix.copy(srcJs + 'metisMenu.min.js', destJs);
